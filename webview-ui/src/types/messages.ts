...
import type { RmqQueueInfo, RmqMessage } from './rabbitmq';
...
export type ExtensionMessage =
  ...
  | { type: 'rmqQueueList'; queues: readonly RmqQueueInfo[] }
  | { type: 'rmqMessageList'; queue: string; messages: readonly RmqMessage[] }
